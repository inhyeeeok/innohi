/**
* Template Name: footer.js
* Author: inhyeok
* E-mail: ikwon@hist.co.kr
* Remark : 해당 프로젝트에서 사용하는 공통 footer js 파일을 로딩한다.
*/
(function() {
  "use strict";
  
const headerHtml = "<div class='footer-top'>"
				 + "<div class='container'>"
				 + "<div class='row'>"
						+ "<div class='col-lg-3 col-md-6 footer-contact'>"
						+ "<h3><img src='../assets/img/clients/hist.png' class='img-fluid' style='width: 200px;'alt=''></h3>"
						+ "<p>"
						+ "한진정보통신 주식회사<br> 대표자명: 박은호"
						+ "</p>"
						+ "</div>"
