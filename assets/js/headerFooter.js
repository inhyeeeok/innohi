...
(function() {
  "use strict";
	...
	//				 + "<li><a class='nav-link scrollto active' href='main.html'>Home</a></li>"
					...
					+ "<li><a href='https://docs.google.com/forms/d/e/1FAIpQLSdHnXT1VGX3OWoH8K1slTlkIWtLNIpNShk5k-8fBI-CxO6yow/viewform'>스타트업 소싱 요청</a></li>"
		...
		footerHtml : "<div class='footer-top'>"
					...
					+ "<div class='row'>"
					   ...
					   +"</div>"
					+ "<div class='credits'>"
				   	+ "문의하기 : <a href='#'>SELHTDB@hist.co.kr</a>"
					+ "</div>"
					+ "</div>",
